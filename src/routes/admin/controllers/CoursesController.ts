...
export async function findAll(_: Request, response: Response) {
  try {
...
export async function createCourses(request: Request, response: Response) {
  try {
...
export async function updateCourses(request: Request, response: Response) {
  try {
    const { id } = request.params
...
export async function deleteCourses(request: Request, response: Response) {
  try {
    const { id } = request.params
