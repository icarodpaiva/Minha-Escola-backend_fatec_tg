...
export async function createAccess(request: Request, response: Response) {
  try {
...
export async function updateAccess(request: Request, response: Response) {
  try {
    const { id } = request.params
    const { type } = request.body
...
export async function deleteAccess(request: Request, response: Response) {
  try {
    const { id } = request.params
